...
// (returns the single item- there is only one in this page)
...
console.dir(h1); 
// console.dir(h1[0]); 
// selecting the first element in the html collection
...
h1[0].classList.remove(`background`); 
...
h5.innerText= "See ya in the Windy City!";
